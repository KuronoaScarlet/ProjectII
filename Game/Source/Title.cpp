...
bool Title::Start()
{
    ...
    play = new GuiButton(1, { 517, 304, 145, 39 }, "START");
    ...
    newGame = new GuiButton(12, { 517, 370, 174, 45 }, "START");
    ...
    options = new GuiButton(2, { 543, 438, 137, 43 }, "OPTIONS");
    ...
    credits = new GuiButton(13, { 551, 514, 122, 39 }, "CREDITS");
    ...
    exit = new GuiButton(4, { 580, 569, 67, 34 }, "EXIT");
